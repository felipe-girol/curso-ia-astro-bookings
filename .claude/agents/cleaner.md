...
- Run  `/Plan` to create a plan for cleaning up the code following the steps below and return the plan as a todo list of tasks.
...
- The specification file (in `IA/specs/`) with detailed acceptance criteria to keep in mind during the cleanup.
